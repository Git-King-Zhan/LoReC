...
def train():
    ...
    print("model.config.pretrain_graph_model_path: ", model.config.pretrain_graph_model_path)
    ...
    if list(pathlib.Path(training_args.output_dir).glob("checkpoint-*")):
        ...
        #trainer.train(resume_from_checkpoint="/gemini/code/GraphGPT-main/checkpoints/stage_1/checkpoint-19200")
    else:
        trainer.train()
    trainer.save_state()

    # checkpoint_dir = "/gemini/code/GraphGPT-main/checkpoints/stage_1/"
